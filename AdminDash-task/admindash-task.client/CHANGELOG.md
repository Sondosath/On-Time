...
- Create Angular project with ng: `ng new admindash-task.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`admindash-task.client.esproj`).
