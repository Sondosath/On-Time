...
- Create Angular project with ng: `ng new aaaaaaaaaaaaaaaaaaaaaaa.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`aaaaaaaaaaaaaaaaaaaaaaa.client.esproj`).
