...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-BJH6DOD;Database=MVC_Project;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Attendance>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Attendan__3214EC273260799D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Departme__3214EC2715A0848C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC27B935287D");

            entity.HasIndex(e => e.Email, "UQ__Employee__A9D105348E94BD34").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Evaluati__3214EC2718B5DB68");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Feedback__3214EC27E1DB0C81");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HR__3214EC272B3CF858");

            entity.ToTable("HR");

            entity.HasIndex(e => e.Email, "UQ__HR__A9D10534B7444734").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LeaveReq__3214EC2756DF747C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Managers__3214EC27438F02DB");

            entity.HasIndex(e => e.Email, "UQ__Managers__A9D10534E25CE44B").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Tasks__3214EC27738C46E3");
